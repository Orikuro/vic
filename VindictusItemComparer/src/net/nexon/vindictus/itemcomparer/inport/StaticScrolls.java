...
public class StaticScrolls {
	...
	private final static ScrollRestriction CLOTH_LIGHT_ALL = new ScrollRestriction(CLOTH_LIGHT);
	private final static ScrollRestriction HEAVY_ALL = new ScrollRestriction(HEAVY);
	private final static ScrollRestriction HEAVY_PLATE_ALL = new ScrollRestriction(HEAVY_PLATE);
	
	private final static ScrollRestriction CLOTH_LIGHT_PANTS_HELM = new ScrollRestriction(CLOTH_LIGHT, PANTS_HELM);
	private final static ScrollRestriction HEAVY_PLATE_PANTS_HELM = new ScrollRestriction(HEAVY_PLATE, PANTS_HELM);
	
	private final static ScrollRestriction CLOTH_LIGHT_SHOES_GLOVES = new ScrollRestriction(CLOTH_LIGHT, SHOES_GLOVES);
	private final static ScrollRestriction HEAVY_PLATE_SHOES_GLOVES = new ScrollRestriction(HEAVY_PLATE, SHOES_GLOVES);
	
	private final static ScrollRestriction CLOTH_ARMOR = new ScrollRestriction(CLOTH_LIGHT);
	private final static ScrollRestriction HEAVY_ARMOR = new ScrollRestriction(HEAVY, ARMOR);
	private final static ScrollRestriction ONLY_ARMOR = new ScrollRestriction(ALL_ITEMS, ARMOR);

	public final static Scroll_Suf enthu = new Scroll_Suf("Enthu", -370, 270, 282,
			SCRPROP.getEnthu());
